export function BrandBagIcon({ size = 24, color = '#fff' }) {
  return (
    <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_150_1229)">
        ...
        <path d="M36.0988 34.6014C36.1313 34.9985 35.8211 35.339 35.4268 35.339H5.59438C5.2009 35.339 4.89092 35.0002 4.92208 34.6037L7.06376 7.34718C7.09168 6.9927 7.38426 6.71973 7.73606 6.71973H33.1958C33.5468 6.71973 33.8391 6.99161 33.868 7.34499L36.0988 34.6014Z" fill="url(#paint0_linear_150_1229)" />
      ...
      <defs>
        <linearGradient id="paint0_linear_150_1229" x1="29.8733" y1="31.3337" x2="11.5132" y2="9.9008" gradientUnits="userSpaceOnUse">
          <stop stop-color="#52D67A" />
          <stop offset="1" stop-color="#5AEE87" />
        </linearGradient>
        <clipPath id="clip0_150_1229">
...
export function CartIcon({ size = 20, color = '#1D1F22' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path
        d="M6.3 6.5h15l-2 8.5H8.2L6.3 6.5Z"
        stroke={color}
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path d="M6.3 6.5 5.6 4H3" stroke={color} strokeWidth="1.6" strokeLinecap="round" />
      <circle cx="9" cy="19" r="1.3" fill={color} />
      <circle cx="18" cy="19" r="1.3" fill={color} />
    </svg>
  )
}

export function ChevronLeft({ size = 18, color = '#fff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
export function ChevronRight({ size = 18, color = '#fff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path d="M9.5 6 15.5 12l-6 6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
